...
// ============================================================================
// CUSTOM LOGIN PAGE - Username/Password Authentication
// ============================================================================
...
export default function Login() {
  ...
  const loginMutation = trpc.credentials.login.useMutation({
    onSuccess: (data) => {
    ...
    <div className="min-h-screen bg-[#0a0a0a] flex items-center justify-center px-4">
      ...
      >
        ...
        <div className="bg-[#111111] border border-[#222222] rounded-xl p-8">
          <h2 className="text-xl font-semibold text-white mb-6 text-center">Member Login</h2>
        ...
        <p className="text-center text-gray-600 text-xs mt-6">
          Access is by invitation only. Contact an existing member for credentials.
        </p>
      </motion.div>
    </div>
  );
