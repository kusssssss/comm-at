      ...
      <main className="pt-24 pb-16 px-4">
        <div className="container mx-auto max-w-2xl">
          ...
          <motion.div
            ...
            className="mb-8 p-6 border border-purple-500/30 bg-purple-500/5 rounded-lg"
          >
            ...
            {codeLoading ? (
              ...
              <>
                <div className="flex items-center gap-3 mb-4">
                  <code className="flex-1 text-2xl md:text-3xl font-mono font-bold text-purple-400 bg-black/30 px-4 py-3 rounded border border-purple-500/20">
                    {codeData?.code || '---'}
                  </code>
                  <button
                    onClick={copyToClipboard}
                    className="p-3 bg-purple-500/20 hover:bg-purple-500/30 rounded transition-colors"
                    title="Copy code"
                  >
                    {copied ? <Check className="w-6 h-6 text-green-400" /> : <Copy className="w-6 h-6 text-purple-400" />}
                  </button>
                </div>
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  <button
                    onClick={copyToClipboard}
                    className="flex-1 flex items-center justify-center gap-2 px-4 py-3 bg-purple-600 hover:bg-purple-500 text-white rounded transition-colors"
                  >
                  ...
                  <button
                    ...
                    className="flex-1 flex items-center justify-center gap-2 px-4 py-3 border border-purple-500/50 hover:bg-purple-500/10 text-purple-400 rounded transition-colors"
                  >
          ...
          >
            <div className="p-4 border border-purple-500/20 rounded-lg text-center">
          ...
          <motion.div
            ...
            className="mb-8 p-6 border border-purple-500/20 rounded-lg"
          >
            <h3 className="text-lg font-bold text-purple-400 mb-4">HOW IT WORKS</h3>
          ...
          {history && history.length > 0 && (
            <motion.div
              ...
              className="p-6 border border-purple-500/20 rounded-lg"
            >
              <h3 className="text-lg font-bold text-purple-400 mb-4">REFERRAL HISTORY</h3>
