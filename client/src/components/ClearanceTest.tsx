        ...
        {!showTest && !submitted && (
          ...
          >
            ...
            <button
              ...
              className="px-8 py-3 bg-[#3B82F6] text-white font-mono text-sm tracking-wider rounded-lg hover:bg-[#1D4ED8] transition-colors"
            >
              START TEST
            </button>
          </motion.div>
          ...
          >
            ...
            >
              ...
              <button
                ...
                className="px-6 py-2 bg-[#3B82F6] text-white font-mono text-sm rounded-lg hover:bg-[#1D4ED8] disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
              >
                SUBMIT ANSWERS
              </button>
            </motion.div>
