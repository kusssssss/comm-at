    ...
    <div className={`relative ${className}`}>
        ...
        <div className="absolute inset-0 flex items-center justify-center bg-black/60 backdrop-blur-sm">
          <div className="text-center p-6 max-w-sm">
            ...
            <Link href={message.href}>
              <Button variant="outline" className="border-#3B82F6/50 text-#3B82F6 hover:bg-#3B82F6/10">
      ...
      {!isBlurred && isRestricted && (
        <div className="absolute top-2 right-2">
          <div className="px-2 py-1 bg-#3B82F6/20 rounded text-xs text-#3B82F6 flex items-center gap-1">
...
export function VisibilityBadge({ 
  ...
  return (
    <div className="inline-flex items-center gap-1 px-2 py-0.5 bg-#3B82F6/20 rounded text-xs text-#3B82F6">
      <Lock className="w-3 h-3" />
